...
## DYA Studio PR 168 update 2026-08-28

External [cormoran/dya-studio PR #168](https://github.com/cormoran/dya-studio/pull/168) merged at `2026-08-27T16:27:12Z` (JST 2026-08-28 01:27), with merge commit [`ca39a358`](https://github.com/cormoran/dya-studio/commit/ca39a3585258ad623dadefc394d226013ea3f81b). This is upstream merge evidence only. The official distribution reflecting the change, and new MKB Peripheral source-enumeration/diagnostics hardware validation, remain unconfirmed; no claim of all CI success or official publication is made.
...
- External [cormoran/dya-studio PR #168](https://github.com/cormoran/dya-studio/pull/168) is recorded in the dated update above as merged; distribution and hardware validation remain pending.
...
4. **Official DYA Studio Peripheral validation — waiting:** verify distribution reflection and then use the applicable version to confirm Peripheral PMW3610 source enumeration and diagnostics on the existing MKB right-TBv4 hardware; PR merge alone is not hardware evidence.
